---
title: "Fakeperms"
description: "The Fake Permissions System lets administrators grant fake Discord permissions to roles. These do not modify actual Discord permissions but allow roles to bypass permission checks inside the bot.
